...
const showChat = () => {
  // activeicon
  let chatbuttondiv = document.querySelector('.chatbutton');
  console.log(chatbuttondiv);
  let isbutton = document.querySelector('.activeicon');
  if (isbutton) {
    document.querySelector('.main__right').style = "display:none";
    chatbuttondiv.classList.remove("activeicon")
  } else {
    document.querySelector('.main__right').style = "display:block";
    chatbuttondiv.classList.add("activeicon")
  }
